...
{
	$uid=$_GET['Id'];
	$del="DELETE FROM payment WHERE Id=".$uid;
	$del1="DELETE FROM payment WHERE Id=".$uid;
	$res=mysql_query($del);
	...
	<h1><b><p style="color:#660000;size:50">Search Data:</p></b></h1>
			...
			<tr>
			 ...
			 <tr align="center">
					...
					<input type="reset" name="reset" value="Clear All" class="but" onClick="javascript:location.href='admin_payment.php'"  />			
			  </td>
			</tr>
  </table>
</form>
...
<table width="70%" align="center" border="5" class="tblbg" cellspacing="1" cellpadding="1"  bgcolor="#000000" bordercolor="#aa9166">
	<tr  class="c1">
		...
		<th width="11%">Id</th>
		<th width="16%" >file_name 	</th>
		<th width="16%" >uploaded_on</th>
		<th width="16%" >Mo </th>
	...
	if(isset($_REQUEST["txtsearch"]) && strlen($_REQUEST["txtsearch"]) > 0)
		$myCondition = " WHERE file_name LIKE '%".$_REQUEST["txtsearch"]."%'";
	
	$qry_select = "SELECT * FROM payment".$myCondition;
	...
	if($cnt_select > 0)
	{
		...
		{?>
			<tr class="a">
				...
				<td align="center"><a href="admin_payment.php?Id=<?php echo $row['Id']; ?>"><img src="img/b_drop.png" style="margin-left:10" border="0" /></a><br /></td>
