...
{
	$uid=$_GET['Id'];
	$del="DELETE FROM  shipping WHERE Id=".$uid;
	$del1="DELETE FROM  shipping WHERE Id=".$uid;
	$res=mysql_query($del);
	...
	<H1><b><p style="color:#660000;size:50">Search Data:</p></b></H1>
			...
			<tr>
			 ...
			 <tr align="center">
					...
					<input type="reset" name="reset" value="Clear All" class="but" onClick="javascript:location.href='admin_ shipping.php'"  />			
			  </td>
			</tr>
  </table>
</form>
...
<table width="80%" align="center" border="5" class="tblbg" cellspacing="1" cellpadding="1"  bgcolor="#000000" bordercolor="#aa9166">
	<tr class="c1">
		...
		<th width="11%" >Id</th>
		<th width="16%" >Enter Name</th>
		<th width="16%" >Enter E-Mail</th>
		<th width="16%" >Enter Phone</th>
		<th width="16%" >Enter Delivery Address Here</th>
	...
	$qry_select = "SELECT * FROM  shipping".$myCondition;
	...
	if($cnt_select > 0)
	{
		...
		{?>
			<tr class="a">
				...
				<td><?php echo $row['Enter E-Mail']; ?></td>
				<td><?php echo $row['Enter Phone']; ?></td>
				<td><?php echo $row['Enter Delivery Address Here...']; ?></td>
				<td><?php echo $row['product_name']; ?></td>
				<td><?php echo $row['Price']; ?></td>
				
				
				
				<td align="center"><a href="admin_shipping.php?Id=<?php echo $row['Id']; ?>"><img src="img/b_drop.png" style="margin-left:10" border="0" /></a><br /></td>
