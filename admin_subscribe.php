...
{
	$uid=$_GET['Id'];
	$del="DELETE FROM subscribe WHERE Id=".$uid;
	$del1="DELETE FROM subscribe WHERE Id=".$uid;
	$res=mysql_query($del);
	...
	<H1><b><p style="color:#660000;size:50">Search Data:</p></b></H1>
			...
			<tr>
			 ...
			 <tr align="center">
					...
					<input type="reset" name="reset" value="Clear All" class="but" onClick="javascript:location.href='admin_subscribe.php'"  />			
			  </td>
			</tr>
  </table>
</form>
...
<table width="80%" align="center" border="5" class="tblbg" cellspacing="1" cellpadding="1"  bgcolor="#000000" bordercolor="#aa9166">
	...
	$qry_select = "SELECT * FROM subscribe".$myCondition;
	...
	if($cnt_select > 0)
	{
		...
		{?>
			<tr class="a">
				...
				<td align="center"><a href="admin_subscribe.php?Id=<?php echo $row['Id']; ?>"><img src="img/b_drop.png" style="margin-left:10" border="0" /></a><br /></td>
		</tr>
		<?php 			
		}
	}
