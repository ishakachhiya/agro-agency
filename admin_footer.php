    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                <h1 class="mb-3 display-5 text-capitalize text-white style1"><span class="text-primary">Agro</span>&nbsp;agency</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-white mb-2" href="ad_home.php"><i class="fa fa-angle-right mr-2"></i>Home</a>
                            <a class="text-white mb-2" href="admin_ product.php"><i class="fa fa-angle-right mr-2"></i>Product</a>
                            <a class="text-white mb-2" href="admin_ shipping.php"><i class="fa fa-angle-right mr-2"></i>shipping</a>
                            <a class="text-white mb-2" href="admin_payment.php"><i class="fa fa-angle-right mr-2"></i>payment</a>
							<a class="text-white mb-2" href="admin_feedback.php"><i class="fa fa-angle-right mr-2"></i>Feedback</a>
                            <a class="text-white" href="admin_contact.php"><i class="fa fa-angle-right mr-2"></i>Contact Us</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-md-right">
                <ul class="nav d-inline-flex">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" href="admin_register.php">Register</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" href="admin_faq.php">FAQs</a>
                    </li>
...
$q=mysql_query("insert into subscribe values('','$Name','$Em')");
	if($q)
	{
	...
	{
		echo"<script> alert(' not subscribed...')</script>";
	}
	}
?>
