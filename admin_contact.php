...
{
	$uid=$_GET['Id'];
	$del="DELETE FROM contact WHERE Id=".$uid;
	$del1="DELETE FROM contact WHERE Id=".$uid;
	$res=mysql_query($del);
	...
	<h1><b><p style="color:#660000;size:50">Search Data:</p></b></h1>
			...
			<tr>
			 ...
			 <tr align="center">
					...
					<input type="reset" name="reset" value="Clear All" class="but" onClick="javascript:location.href='admin _contact.php'"  />			
			  </td>
			</tr>
  </table>
</form>
...
<table width="70%" align="center" border="5" class="tblbg" cellspacing="1" cellpadding="1"  bgcolor="#000000" bordercolor="#aa9166">
	...
	$qry_select = "SELECT * FROM contact".$myCondition;
	...
	if($cnt_select > 0)
	{
		...
		{?>
			<tr class="a">
				...
				<td align="center"><a href="admin_contact.php?Id=<?php echo $row['Id']; ?>"><img src="img/b_drop.png" style="margin-left:10" border="0" /></a><br /></td>
